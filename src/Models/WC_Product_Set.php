...
class WC_Product_Set extends \WC_Product
{
    ...
    public function get_child_products_as_wc_product()
    {
    ...
    public function get_child_products(): array
    {
        ...
        $children = apply_filters('Elderbraum/WooProductSet/models/get-children', $this->get_meta(self::K_CHILD_PRODUCT));
        return $children?: [];
    }
